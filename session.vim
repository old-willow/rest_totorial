...
silent only
cd ~/Dropbox/web-dev/django_projects/rest_tutorial
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +1 rest_tutorial/settings.py
badd +0 rest_tutorial/urls.py
badd +0 snippets/views.py
badd +0 snippets/models.py
badd +1 snippets/serializers.py
argglobal
silent! argdel *
argadd rest_tutorial/settings.py
argadd rest_tutorial/urls.py
set stal=2
edit rest_tutorial/settings.py
